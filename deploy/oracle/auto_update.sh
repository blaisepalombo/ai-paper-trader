...
if ! run_as_app_user "'${PYTHON_BIN}' -m py_compile bot_config.py paper_bot.py trade_exit.py autonomous_trader.py discord_control.py heartbeat_reporter.py"; then
  rollback
  exit 1
fi
